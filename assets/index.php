                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="btn-div">
                                          <a class="btn-mode-one" href="#">EN SAVOIR +</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="card">
                                    <img class="img-fluid" alt="100%x280" src="images/travel.svg">
                                    <div class="card-body">
                                        <h4 class="card-title">Special title treatment</h4>
                                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                        <div class="btn-div">
                    ...
                    <div class="carousel-item">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="card">
                                    <img class="img-fluid" alt="100%x280" src="images/accident.svg">
                                    <div class="card-body">
                                        <h4 class="card-title">Special title treatment</h4>
                                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                        <div class="btn-div">
...
<div class="tp-section">
  <div class="container">
    ...
    <div class="col-sm-4">
      ...
      <div class="col-sm-8">
        <p class="p-resize">test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph test paragraph</p>
        <ul>
          <li><i class="fas fa-square"></i>Hey hey hey he</li>
          <li><i class="fas fa-square"></i>Hey hey hey he</li>
          <li><i class="fas fa-square"></i>Hey hey hey he</li>
        </ul>
        <div class="btn-div">
